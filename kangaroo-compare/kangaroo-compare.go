...
func main(){
    ...
    if len(new_file)==len(original_file){
    	...
    	fmt.Printf("This files have %d differences of a total of %d bytes. It is a %f/100", differences,len(original_file), float32(differences)*100/float32(len(original_file)))
